...
void mind1(tri_race* x_tri)                                         /* ez nem referencia, dinamikus memóriát használok, ezért ez egy cím */
 { cout << endl;
   x_tri->kiir_rajt().setSum(x_tri->getIj()).kiir_cel(); }          /* itt -> használunk mert címre hivatkozom */
   
void felsz(tri_race* x_tri)                                         /* nem tagfüggvénnyel szabadítom fel */
 { delete x_tri; }