...
class tri_race			/* szülő osztály deklarációja */
{
   	...
   	public:
		...
		tri_race(string lc, int sw, int cyc, int rn, int dp, int t) : oRA(3600), pRC(60), h(0), p(0), mp(0), sum(0)
		...
		tri_race(const tri_race&) = delete;                  /* a hármashoz a vizsgán ez a sor is kell */
