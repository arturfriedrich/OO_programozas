...
in_gr_ch& in_gr_ch::kiir_rajt()			/* unoka rajt kiíró metódus */
	{ cout << "\nUnoka rajt idő: "; kiir_i1(); return *this; }

in_gr_ch& in_gr_ch::kiir_cel()			/* unoka cél kiíró metódus */
	{ kiir_i4();
...
void mind(tri_race& alap, tri_race& A_tri, tri_race& B_tri, tri_race& C_tri)		/* egy metódus hívja meg az összes láncolt függvényt */
	{ cout << endl;
