...
class tri_race {
	...
	public:				/* csak ez maradt publikus, mivel úgyis csak a gyerek akarja elérni a többit, az pedig tudja a privátot is */
...
class in_ch : protected tri_race, protected h_m_s			/* maximális védelem */
{
	...
	public:				/* a gyerek default konstruktorát publikusan kell tartani */
